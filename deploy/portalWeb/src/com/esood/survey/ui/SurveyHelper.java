 ...
 */
	protected void initializeAnswers()
	{
		...
		{
			efficiencyAnswers=new ArrayList();
	...
	protected void initializeQuestions()
	{
		...
		{
			efficiencyQuestions=new ArrayList();
